...
def main():
    ...
    df = pd.read_csv(freqs_file)
    out =  "/sternadi/home/volume3/taliakustin/TiLV_sequencing/freqs_with_mutations/" + freqs_file.split("/")[-1].split(".")[0] + ".csv"
    add_mutation_to_freq_file(out, freqs=df)
