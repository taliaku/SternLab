...
ref="/sternadi/home/volume1/shared/data/ref_genomes/HIV_C/Ref_C_ET86.fasta"

# low_qual run
dir_low="/sternadi/home/volume1/shared/analysis/HIV_ravi_gupta/runs/ET86_merged_low_qual/iter1"
cons_dir_low="$dir_low/cons"
input_file_low="$dir_low/$sample/$freqs_filename"
output_file_low="$cons_dir_low/$cons_filename"

mkdir -p $cons_dir_low
python /sternadi/home/volume3/omer/SternLab/NGS_analysis/make_reference_from_consensus.py -f $ref -p $input_file_low -o $output_file_low

# high_qual run
dir_high="/sternadi/home/volume1/shared/analysis/HIV_ravi_gupta/runs/ET86_merged_high_qual/iter1"
cons_dir_high="$dir_high/cons"
input_file_high="$dir_high/$sample/$freqs_filename"
output_file_high="$cons_dir_high/$cons_filename"

mkdir -p $cons_dir_high
python /sternadi/home/volume3/omer/SternLab/NGS_analysis/make_reference_from_consensus.py -f $ref -p $input_file_high -o $output_file_high
...
# low_qual run
dir_low="/sternadi/home/volume1/shared/analysis/HIV_ravi_gupta_control/runs/ET86_low_qual/iter1/1st_line_VF"
cons_dir_low="$dir_low/cons"
input_file_low="$dir_low/$sample/$freqs_filename"
output_file_low="$cons_dir_low/$cons_filename"
...
# high_qual run
dir_high="/sternadi/home/volume1/shared/analysis/HIV_ravi_gupta_control/runs/ET86_high_qual/iter1/1st_line_VF"
cons_dir_high="$dir_high/cons"
input_file_high="$dir_high/$sample/$freqs_filename"
output_file_high="$cons_dir_high/$cons_filename"
...
# low_qual run
dir_low="/sternadi/home/volume1/shared/analysis/HIV_ravi_gupta_control/runs/ET86_low_qual/iter1/Baseline"
cons_dir_low="$dir_low/cons"
input_file_low="$dir_low/$sample/$freqs_filename"
output_file_low="$cons_dir_low/$cons_filename"
...
# high_qual run
dir_high="/sternadi/home/volume1/shared/analysis/HIV_ravi_gupta_control/runs/ET86_high_qual/iter1/Baseline"
cons_dir_high="$dir_high/cons"
input_file_high="$dir_high/$sample/$freqs_filename"
output_file_high="$cons_dir_high/$cons_filename"
